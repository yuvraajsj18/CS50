...
def buy():
    ...
    if request.method == "POST":
        ...
        try:
            buy = db.execute("INSERT INTO transactions (id, price, symbol, shares, buy_sell) VALUES (:userId, :price, :symbol, :shares, :buy_sell)",
                                    userId=userId, price=price, symbol=symbol, shares=shares, buy_sell=buy_sell)
            cash = userInfo[0]['cash'] - total
            userUpdateCash = db.execute("UPDATE users SET cash = :cash WHERE id = :userId", cash=cash, userId=userId)
        except:
...
def sell():
    ...
    if request.method == "POST":
        ...
        buy_sell = 'S'
        sell = db.execute("INSERT INTO transactions (id, symbol, shares, price, buy_sell) VALUES (:userId, :symbol, :shares, :price, :buy_sell)",
        ...
        userUpdate = db.execute("UPDATE users SET cash = :cash WHERE id = :userId", cash = cash, userId = userId)
